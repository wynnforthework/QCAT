...
func (m *mockExchangeClient) PlaceOrder(ctx context.Context, order interface{}) error { return nil }
func (m *mockExchangeClient) CancelOrder(ctx context.Context, orderID string) error { return nil }
func (m *mockExchangeClient) CancelAllOrders(ctx context.Context, symbol string) error { return nil }
func (m *mockExchangeClient) GetOrderStatus(ctx context.Context, orderID string) (interface{}, error) { return nil, nil }
func (m *mockExchangeClient) GetBalance(ctx context.Context, currency string) (float64, error) { return 1000.0, nil }
func (m *mockExchangeClient) GetPositions(ctx context.Context) ([]interface{}, error) { return nil, nil }

type mockDB struct{}

func (m *mockDB) Query(query string, args ...interface{}) error { return nil }
func (m *mockDB) QueryRow(query string, args ...interface{}) interface{} { return nil }
func (m *mockDB) Exec(query string, args ...interface{}) error { return nil }
func (m *mockDB) Begin() (interface{}, error) { return nil, nil }
